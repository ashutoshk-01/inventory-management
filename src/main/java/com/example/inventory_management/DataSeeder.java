...
public class DataSeeder implements CommandLineRunner {
    ...
    private void initializeAdminRoleAndUser() {
        ...
        // Check and create Manager role if not present
        ...
        // Check and create Employee role if not present
        ...
        if (userRepository.findByEmailAndActive("admin@domain.com", true).isEmpty()) {
            ...
            adminUser.setAssigned(roleRepository.findByName("ADMIN").get());
            userRepository.save(adminUser);
        }

        // Check and create Employee user if not present
        if (userRepository.findByEmailAndActive("employee@domain.com", true).isEmpty()) {
            User employeeUser = new User();
            employeeUser.setEmail("employee@domain.com");
            employeeUser.setPassword(new BCryptPasswordEncoder().encode("employeepassword"));
            employeeUser.setActive(true);
            employeeUser.setContact("9876543210");
